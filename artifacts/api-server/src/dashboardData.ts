...
export async function fetchHomeFunnel(preset: string): Promise<HomeFunnel> {
  ...
  const steps: HomeFunnelStep[] = [
    ...
    { key: "vsl_auto",   label: "VSL started (autoplay)",    n: ev.vsl_autoplay || 0,    source: "db",   note: "video began playing (muted) for the visitor" },
    { key: "vsl_30s",    label: "VSL — past 30s",            n: ev.vsl_t30s || 0,        source: "db",   note: "got past the hook" },
    { key: "vsl_1m",     label: "VSL — reached 1 min",       n: ev.vsl_t1m || 0,         source: "db" },
    { key: "vsl_2m",     label: "VSL — reached 2 min",       n: ev.vsl_t2m || 0,         source: "db" },
    { key: "vsl_5m",     label: "VSL — reached 5 min",       n: ev.vsl_t5m || 0,         source: "db" },
    { key: "vsl_10m",    label: "VSL — reached 10 min",      n: ev.vsl_t10m || 0,        source: "db" },
    { key: "vsl_done",   label: "VSL completed (~17min)",    n: ev.vsl_complete || 0,    source: "db" },
    { key: "vsl_play",   label: "VSL play with SOUND (unmute)",n: ev.vsl_play || 0,      source: "db",   note: "tapped 'tap for sound' — strong intent" },
