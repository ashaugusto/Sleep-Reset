    ...
    return {
      ...
      html: wrap(`
        ...
        <p style="margin:28px 0 0;font-size:12px;color:#8b949e;line-height:1.5;">
          30-day money-back. If it doesn't work, keep everything and we refund.
        </p>
      `),
    };
  }
