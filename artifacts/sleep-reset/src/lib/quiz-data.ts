...
// breaks typing. Labels and feedback are safe to change.
//
// Two house rules, both learned the hard way:
//   1. No em dash in anything the visitor reads. Colon, full stop or comma.
//      A page full of em dashes reads as machine-written.
//   2. No emoji. The answers carry an index letter instead, set by the page.
//
// And the old one, worth repeating: no claim we can't support. No "1,200
// profiles analysed", no "join X people". If one appears here, it goes.
...
export const INTRO = {
  ...
  // What the visitor walks away with, in the order they get it. This is not
  // decoration: it is the contract, and it is what fills the first screen
...
/** Analysis screen: one line every 800ms, the finished ones dim out. */
...
export const CAPTURE = {
  ...
  // Not optional. The hero promised no email to see the result, and gating what
  // comes after breaks that promise with the sceptic, who is the buyer.
  skip: "Keep reading without it",
};
